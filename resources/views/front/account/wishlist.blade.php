                            ...
                            @foreach ($wishlists as $wishlist)
                                <div class="d-sm-flex justify-content-between mt-4 mb-4 pb-3 pb-sm-2 border-bottom">
                                    ...
                                    <div class="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                                        <button onclick="removeProduct({{ $wishlist->product_id }});" class="btn btn-danger btn-sm" type="button">
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == true) {
                        window.location.href = "{{ route('account.wishlist') }}";  // Redirect to wishlist page
                    } else {
