      ...
      <div class="hero-content">
        <div class="row">
          <div class="col-12 col-lg-5">
            <h2 class="hero-title">Reset Password</h2>
          </div>
        </div>
      </div>
      <!-- End .hero-content-->
                ...
                <div class="col-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                    <div class="login-card">
                        ...
                        <div class="login-body">
                            <form class="loginForm mb-0" method="post" action="{{ route('front.processResetPassword') }}">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="password" class="form-control @error('new_password') is-invalid @enderror" 
                                               placeholder="New Password" name="new_password" id="new_password" value="">
                                        @error('new_password')
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="password" class="form-control @error('confirm_password') is-invalid @enderror" 
                                               placeholder="Confirm Password" name="confirm_password" id="confirm_password" value="">
