                        ...
                        <div class="card">
                            <div class="card-body">	
                                ...
                                <div class="form-group">
                                    <label>
                                        <input type="checkbox" name="is_custom_price" value="1" {{ old('is_custom_price', $product->is_custom_price ?? 0) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="audio_url" id="audio_url" class="form-control" placeholder="https://example.com/audio.mp3" value="{{ old('audio_url', $product->audio_url ?? '') }}">
                                        <p class="error"></p>
                                    </div>
                                </div>
                                                                    {{-- <div class="mb-3">
